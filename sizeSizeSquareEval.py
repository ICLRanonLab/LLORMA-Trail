...
#MEAN
    ...
    # make Answer
    CSVname = str(testType)+str(error)+'-'+str(mean)+'-'+str(size) + '.csv'
    ...
    AnswerName = 'Answer'+str(testType)+str(error)+'-'+str(mean)+'-'+str(size) +'.csv'
    ...
    kind = 'ptmatrix-' + str(testType) +'-'+ str(error) +'-'+ str(mean) +'-'+ str(size)
    print(kind)


    #PQ Analyzer
    pNAME = './llorma_g/ptmatrix-size-' + str(error)+'-'+str(mean)+'-'+str(size)+'-p.npy'
    qNAME = './llorma_g/ptmatrix-size-' + str(error) + '-' + str(mean) + '-' + str(size) + '-q.npy'
    p = np.load(pNAME)
    q = np.load(qNAME)
    ...
    csv1 = str(testType) + str(error) + '-' + str(mean) + 'TPTN' + '.csv'
    res1 = list([testType, error, mean, size, confuMat[0, 0], confuMat[1, 1]])
